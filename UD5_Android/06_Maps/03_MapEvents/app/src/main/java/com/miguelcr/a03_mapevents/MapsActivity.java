package com.miguelcr.a03_mapevents;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener, GoogleMap.OnMarkerDragListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markerMiPosicion = mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Sydney"));
    ...
    public void onMarkerDragEnd(Marker marker) {
        LatLng posicionMarker = marker.getPosition();
        marker.setSnippet(posicionMarker.latitude+","+posicionMarker.longitude);
